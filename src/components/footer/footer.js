    ...
    <footer className="page-footer">
      <div className="page-footer__wrapper">
        <div className="page-footer__logo">
          <Logo />
          <p className="page-footer__text page-footer__text--logo">
        ...
        <div className="page-footer__mobile">
          ...
          <span className="page-footer__mobile-number">*0904</span>
        ...
        <div className="page-footer__mobile">
          ...
          <a className="page-footer__phone-number" href="tel:88001112233">
            8 800 111 22 33
          </a>
          <p className="page-footer__text">
            Бесплатный для всех
        ...
        <div className="page-footer__socials">
          <Link className="page-footer__social" aria-label="faceboock" to="#">
            <svg
              width="9"
              height="16"
              viewBox="0 0 9 16"
          ...
          <Link className="page-footer__social" aria-label="instagram" to="#">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <Link className="page-footer__social" aria-label="twitter" to="#">
            <svg
          ...
          <Link className="page-footer__social" aria-label="youtube" to="#">
            <svg
              width="16"
              height="13"
              viewBox="0 0 16 13"
