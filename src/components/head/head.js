            ...
            <section className="head">
                <div className="head__wrapper">
                    <div className="head__wrapper-credit">
                        ...
                        <Link className="btn head__wrapper-button" aria-label="Рассчитать кредит" to="/">Рассчитать
                            кредит</Link>
                    </div>
                    <div className="head__image-wrapper">
                        <img alt="Белая кредитная карта" className="head__white-card" height="182"
                             src={whiteCard} width="289"/>
                        <img alt="Черная кредитная карта" className="head__black-card" height="182"
                             src={blackCard} width="289"/>
                    </div>
                </div>
            </section>
        </>
